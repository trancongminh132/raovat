...
var login = {
	...
	build_login_template : function(uid, uname, shop, level) {
		...
		if(uname != '')
		{
			loginHtml = '<ul class="site-nav"><li><div class="loggedin"><span><a class="profile-links"><img src="'+ Settings.imgurl +'/no_avatar.1.0.1.png" width="20" height="20" alt="'+ uname +'"></a></span><span class="screen-name">'+ uname +'</span><div class="dropdown-profile" style="display:none"><div class="dropdown-caret" style="display:none"></div><ul class="user-dropdown">';			
