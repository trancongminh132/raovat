...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb, startDate, endDate) {
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    '<div>' +
                      ...
                      '<input class="m-wrap input-mini" type="text" name="daterangepicker_start" id="daterangepicker_start" value="" disabled="disabled" />' +
                    '</div>' +
                    '<div>' +
                      '<label for="daterangepicker_end">' + this.locale.toLabel + '</label>' +
                      '<input class="m-wrap input-mini" type="text" id="daterangepicker_end" name="daterangepicker_end" value="" disabled="disabled" />' +
                    '</div>' +
    ...
    DateRangePicker.prototype = {
        ...
        clickDate: function (e) {
			...
			var dateStartTmp = parseInt(Date.parse(startDate)/1000) + 6*3600 + 1;
			var dateEndTmp = parseInt(Date.parse(endDate)/1000) + 6*3600 + 24*3600 - 1;
			
			$('#'+id+'_from').val(dateStartTmp);
			$('#'+id+'_to').val(dateEndTmp);
	...
	$.fn.daterangepicker = function (options, cb) {
	    ...
	    this.each(function() {
	    var el = $(this);
	    if(el.attr('id') == 'calendar_one'){
			startDate = time.startCalendarOneDate;
			endDate = time.endCalendarOneDate;
	    }else{
	    	startDate = time.startCalendarSecondDate;
			endDate = time.endCalendarSecondDate;
	    }
	      if (!el.data('daterangepicker'))
	        el.data('daterangepicker', new DateRangePicker(el, options, cb, startDate, endDate));
	    });
	    return this;
	  };
